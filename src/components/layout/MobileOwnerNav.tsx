...
const mainNav = [
  ...
  { href: "/owner/customers",   label: "Customers",  icon: Users,           exact: false },
  { href: "/owner/technicians", label: "Technicians",icon: Wrench,          exact: false },
  { href: "/owner/reports",     label: "Reports",    icon: BarChart3,       exact: false },
];

const sheetItems = [
  { href: "/owner/admins",        icon: ShieldCheck,   label: "Admins"           },
  { href: "/owner/managers",      icon: Star,          label: "Managers"         },
  { href: "/owner/visit-reports", icon: ClipboardList, label: "Visit Reports"    },
  { href: "/owner/account",       icon: Settings,      label: "Account settings" },
];

export default function MobileOwnerNav({ name, photo }: { name: string; photo?: string | null }) {
