...
import ManagerTechniciansClient from "./ManagerTechniciansClient";
import ManagerSignOutButton from "@/components/ManagerSignOutButton";

export default async function ManagerTechniciansPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-5 py-4 md:py-8">
      ...
      <ManagerTechniciansClient technicians={serialised} />
    </div>
  );
}
